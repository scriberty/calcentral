...
OPTS=${CALCENTRAL_JRUBY_OPTS:="-J-Djruby.openssl.x509.lookup.cache=8 -Xcompile.invokedynamic=false -Xcext.enabled=true -J-Djruby.thread.pool.enabled=true -J-Djava.io.tmpdir=${PWD}/tmp"}
